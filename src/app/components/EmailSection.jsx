...
const EmailSection = () => {
  ...
  return (
    <section className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative cursor-none" id="contact">
      <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary-900 to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2" >
          <Link href="https://github.com/Femi-Benjamin" target="_blank" rel="noopener noreferrer">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/benjamin-olufemi-7524ab226/" target="_blank" rel="noopener noreferrer">
